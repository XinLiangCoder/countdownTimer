...
(function ($) {
    ...
    function pauseTimer($this, timerType, opts, func) {
        $("#" + opts.pauseButton).click(function () {
            if ($(this).val() != "resume") {
                $("#" + opts.pauseButton).val("resume").text("继续");
                clearInterval(window['timer_' + timerType + $this.attr('id')]);
            }
            else if ($(this).val() == "resume") {
                $("#" + opts.pauseButton).val("pause").text("暂停");
    ...
    function stopTimer($this, timerType, opts, func) {
        $("#" + opts.stopButton).click(function () {
            if ($(this).val() != "start") {
                $("#" + opts.stopButton).val("start").text("重新开始");
                clearInterval(window['timer_' + timerType + $this.attr('id')]);
                ...
                func($this, opts);
                /** 更新 暂停按钮 **/
                $("#pauseBtnhms").attr("disabled","disabled");
                $("#" + opts.pauseButton).val("pause").text('暂停');
            }
            else if ($(this).val() == "start") {
                $("#" + opts.stopButton).val("stop").text("停止");
                window['timer_' + timerType + $this.attr('id')] = setInterval(function () {
                    func($this, opts)
                }, opts.tickInterval * 1000);
                /** 更新 暂停按钮 **/
                $("#pauseBtnhms").removeAttr('disabled');
                $("#" + opts.pauseButton).val("pause").text("暂停");
            }
        });
    }
